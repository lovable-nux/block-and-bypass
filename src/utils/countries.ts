...
export const timezones = [
  ...
  { code: "Europe/Moscow", name: "Moscow (MSK)" },
  ...
  { code: "Asia/Seoul", name: "Seoul (KST)" },
  { code: "Asia/Kolkata", name: "Kolkata (IST)" },
  ...
  { code: "Africa/Cairo", name: "Cairo (EET)" }
];
